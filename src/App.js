...
function App() {
  return (
    <div className="apppage">
      ...
      >
        <div
          className="container-fluid chattop"
        ...
        >
          ...
          <div
            style={{
              ...
              '--darkreader-inline-bgcolor': '#242525',
            }}
          ...
          <div>
            <div className="row pb-1 pt-2 justify-content-between chatheaderbg-normal align-items-center">
              ...
              <div className="col-8 col-md-8 ps-4">
                <div className="p-0">
                  <div className="row justify-content-start p-0 align-items-center">
                    <div className="col p-0">
                      ...
                      <div className="p-0 m-0" style={{ 'font-size': '13px' }}>
                        <span
                          style={{
                            color: 'rgb(119, 119, 119)',
                            '--darkreader-inline-color': '#9e9587',
                          }}
                        ...
                        <a
                          className="p-0 m-0"
                          role="button"
                          href="/public-profile/?source=recent-chats&amp;char=U3dJdreV9rrvUiAnILMauI-oNH838a8E_kEYfOFPalE&amp;username=Zap"
                          style={{
                            color: 'inherit',
                  ...
                  >
                    ...
                    <div className="col-auto p-0 pe-2">
                      <div className="row align-items-center">
                        <button className="btn col-auto px-0" title="分享聊天">
                          <svg
                            stroke="currentColor"
                            fill="currentColor"
                            stroke-width="0"
                        ...
                        <div className="col-auto px-2 dropdown">
                          <span
            ...
            <div className="text-danger row chatheaderbg-normal">
              <span className="text-center" style={{ 'font-size': '9pt' }}>
                记住：角色说的所有话都是虚构的！
              </span>
            </div>
          </div>
