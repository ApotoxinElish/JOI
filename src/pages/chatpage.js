    ...
    >
      ...
      <div className="react-scroll-to-bottom--css-ucvgr-79elbk css-112ma4v">
        <div className="react-scroll-to-bottom--css-ucvgr-1n7m0yu inner-scroll-view">
          ...
          <div
            className="msg-row msg-row-light-bg"
            style={{ 'z-index': '0', 'margin-top': '0px' }}
          >
            <div
                ...
                <div className="justify-content-start">
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <div className="d-flex flex-row">
                          <div className="d-flex flex-column">JOI</div>
                        </div>
                      </div>
                    </div>
                  </span>
            ...
            <div
              className="swiper swiper-initialized swiper-horizontal swiper-pointer-events message-slider"
              style={{
                'min-height': '150px',
                'margin-top': '-20px',
                'z-index': '1',
            ...
            >
              <div className="swiper-wrapper">
                                ...
                                <div style={{ 'overflow-wrap': 'break-word' }}>
                                  <div>
                                    <p
                                      ...
                                      style={{ 'margin-bottom': '0.5rem' }}
                                    >
                                      Hmmm... I suppose that wasn't a clear
                                      enough way to ask. Lemme try a different
                                      approach...
                                      <br />
                                      Hey, cutie, wanna hang out at Wangsheng
                                      tonight?
                                    </p>
                                  </div>
                                </div>
                                ...
                                <div style={{ 'overflow-wrap': 'break-word' }}>
                                  <div>
                                    <p
                                      ...
                                      style={{ 'margin-bottom': '0.5rem' }}
                                    >
                                      ...Huh? You haven't come to schedule a
                                      funeral, have you?
                                      <em>nervous laughter</em>
                                    </p>
                                  </div>
                                </div>
                              </div>
                ...
                <div className="swiper-slide" style={{ width: '800px' }}>
                  <div className="row p-0 m-0">
                    <div className="col-auto p-0"></div>
                    <div className="col-10 p-2 pt-0">
                      <div>
